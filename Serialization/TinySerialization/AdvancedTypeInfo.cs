...
namespace Expanse.Serialization.TinySerialization
{
    public sealed class AdvancedTypeInfo
    {
        ...
        public void EmitFieldGetters(bool avoidCustomStructBoxing)
        {
            bool useByTypedRefDelegates = avoidCustomStructBoxing && isValueType;

            if (useByTypedRefDelegates)
            {
                for (int i = 0; i < fieldTypeInfos.Length; i++)
                {
                    ...
                    switch (fieldTypeInfo.fieldSerializationType)
                    {
                        case SerializationType.String:
                            fieldTypeInfo.getter = EmitUtil.GenerateFieldGetterDelegateByTypedRef<string>(fieldTypeInfo.fieldInfo);
                            break;
                        case SerializationType.Byte:
                            fieldTypeInfo.getter = EmitUtil.GenerateFieldGetterDelegateByTypedRef<byte>(fieldTypeInfo.fieldInfo);
                            break;
                        case SerializationType.SByte:
                            fieldTypeInfo.getter = EmitUtil.GenerateFieldGetterDelegateByTypedRef<sbyte>(fieldTypeInfo.fieldInfo);
                            break;
                        case SerializationType.Bool:
                            fieldTypeInfo.getter = EmitUtil.GenerateFieldGetterDelegateByTypedRef<bool>(fieldTypeInfo.fieldInfo);
                            break;
                        case SerializationType.Int16:
                            fieldTypeInfo.getter = EmitUtil.GenerateFieldGetterDelegateByTypedRef<short>(fieldTypeInfo.fieldInfo);
                            break;
                        case SerializationType.Int32:
                            fieldTypeInfo.getter = EmitUtil.GenerateFieldGetterDelegateByTypedRef<int>(fieldTypeInfo.fieldInfo);
                            break;
                        case SerializationType.Int64:
                            fieldTypeInfo.getter = EmitUtil.GenerateFieldGetterDelegateByTypedRef<long>(fieldTypeInfo.fieldInfo);
                            break;
                        case SerializationType.UInt16:
                            fieldTypeInfo.getter = EmitUtil.GenerateFieldGetterDelegateByTypedRef<ushort>(fieldTypeInfo.fieldInfo);
                            break;
                        case SerializationType.UInt32:
                            fieldTypeInfo.getter = EmitUtil.GenerateFieldGetterDelegateByTypedRef<uint>(fieldTypeInfo.fieldInfo);
                            break;
                        case SerializationType.UInt64:
                            fieldTypeInfo.getter = EmitUtil.GenerateFieldGetterDelegateByTypedRef<ulong>(fieldTypeInfo.fieldInfo);
                            break;
                        case SerializationType.Half:
                            fieldTypeInfo.getter = EmitUtil.GenerateFieldGetterDelegateByTypedRef<Half>(fieldTypeInfo.fieldInfo);
                            break;
                        case SerializationType.Single:
                            fieldTypeInfo.getter = EmitUtil.GenerateFieldGetterDelegateByTypedRef<float>(fieldTypeInfo.fieldInfo);
                            break;
                        case SerializationType.Double:
                            fieldTypeInfo.getter = EmitUtil.GenerateFieldGetterDelegateByTypedRef<double>(fieldTypeInfo.fieldInfo);
                            break;
                        case SerializationType.Char:
                            fieldTypeInfo.getter = EmitUtil.GenerateFieldGetterDelegateByTypedRef<char>(fieldTypeInfo.fieldInfo);
                            break;
                        case SerializationType.Decimal:
                            fieldTypeInfo.getter = EmitUtil.GenerateFieldGetterDelegateByTypedRef<decimal>(fieldTypeInfo.fieldInfo);
                            break;
                        case SerializationType.DateTime:
                            fieldTypeInfo.getter = EmitUtil.GenerateFieldGetterDelegateByTypedRef<DateTime>(fieldTypeInfo.fieldInfo);
                            break;
                        case SerializationType.DateTimeOffset:
                            fieldTypeInfo.getter = EmitUtil.GenerateFieldGetterDelegateByTypedRef<DateTimeOffset>(fieldTypeInfo.fieldInfo);
                            break;
                        case SerializationType.TimeSpan:
                            fieldTypeInfo.getter = EmitUtil.GenerateFieldGetterDelegateByTypedRef<TimeSpan>(fieldTypeInfo.fieldInfo);
                            break;
                        case SerializationType.Vector2:
                            fieldTypeInfo.getter = EmitUtil.GenerateFieldGetterDelegateByTypedRef<Vector2>(fieldTypeInfo.fieldInfo);
                            break;
                        case SerializationType.Vector3:
                            fieldTypeInfo.getter = EmitUtil.GenerateFieldGetterDelegateByTypedRef<Vector3>(fieldTypeInfo.fieldInfo);
                            break;
                        case SerializationType.Vector4:
                            fieldTypeInfo.getter = EmitUtil.GenerateFieldGetterDelegateByTypedRef<Vector4>(fieldTypeInfo.fieldInfo);
                            break;
                        case SerializationType.Quaternion:
                            fieldTypeInfo.getter = EmitUtil.GenerateFieldGetterDelegateByTypedRef<Quaternion>(fieldTypeInfo.fieldInfo);
                            break;
                        case SerializationType.Rect:
                            fieldTypeInfo.getter = EmitUtil.GenerateFieldGetterDelegateByTypedRef<Rect>(fieldTypeInfo.fieldInfo);
                            break;
                        case SerializationType.Bounds:
                            fieldTypeInfo.getter = EmitUtil.GenerateFieldGetterDelegateByTypedRef<Bounds>(fieldTypeInfo.fieldInfo);
                            break;
                        case SerializationType.IntVector2:
                            fieldTypeInfo.getter = EmitUtil.GenerateFieldGetterDelegateByTypedRef<IntVector2>(fieldTypeInfo.fieldInfo);
                            break;
                        case SerializationType.IntVector3:
                            fieldTypeInfo.getter = EmitUtil.GenerateFieldGetterDelegateByTypedRef<IntVector3>(fieldTypeInfo.fieldInfo);
                            break;
                        case SerializationType.IntVector4:
                            fieldTypeInfo.getter = EmitUtil.GenerateFieldGetterDelegateByTypedRef<IntVector4>(fieldTypeInfo.fieldInfo);
                            break;
        ...
        public void EmitPropertyGetters(bool avoidCustomStructBoxing)
        {
            bool useByTypedRefDelegates = avoidCustomStructBoxing && isValueType;
            ...
            if (useByTypedRefDelegates)
            {
                for (int i = 0; i < propertyTypeInfos.Length; i++)
                {
                    ...
                    {
                        case SerializationType.String:
                            propertyTypeInfo.getter = EmitUtil.GeneratePropertyGetterDelegateByTypedRef<string>(propertyTypeInfo.propertyInfo);
                            break;
                        case SerializationType.Byte:
                            propertyTypeInfo.getter = EmitUtil.GeneratePropertyGetterDelegateByTypedRef<byte>(propertyTypeInfo.propertyInfo);
                            break;
                        case SerializationType.SByte:
                            propertyTypeInfo.getter = EmitUtil.GeneratePropertyGetterDelegateByTypedRef<sbyte>(propertyTypeInfo.propertyInfo);
                            break;
                        case SerializationType.Bool:
                            propertyTypeInfo.getter = EmitUtil.GeneratePropertyGetterDelegateByTypedRef<bool>(propertyTypeInfo.propertyInfo);
                            break;
                        case SerializationType.Int16:
                            propertyTypeInfo.getter = EmitUtil.GeneratePropertyGetterDelegateByTypedRef<short>(propertyTypeInfo.propertyInfo);
                            break;
                        case SerializationType.Int32:
                            propertyTypeInfo.getter = EmitUtil.GeneratePropertyGetterDelegateByTypedRef<int>(propertyTypeInfo.propertyInfo);
                            break;
                        case SerializationType.Int64:
                            propertyTypeInfo.getter = EmitUtil.GeneratePropertyGetterDelegateByTypedRef<long>(propertyTypeInfo.propertyInfo);
                            break;
                        case SerializationType.UInt16:
                            propertyTypeInfo.getter = EmitUtil.GeneratePropertyGetterDelegateByTypedRef<ushort>(propertyTypeInfo.propertyInfo);
                            break;
                        case SerializationType.UInt32:
                            propertyTypeInfo.getter = EmitUtil.GeneratePropertyGetterDelegateByTypedRef<uint>(propertyTypeInfo.propertyInfo);
                            break;
                        case SerializationType.UInt64:
                            propertyTypeInfo.getter = EmitUtil.GeneratePropertyGetterDelegateByTypedRef<ulong>(propertyTypeInfo.propertyInfo);
                            break;
                        case SerializationType.Half:
                            propertyTypeInfo.getter = EmitUtil.GeneratePropertyGetterDelegateByTypedRef<Half>(propertyTypeInfo.propertyInfo);
                            break;
                        case SerializationType.Single:
                            propertyTypeInfo.getter = EmitUtil.GeneratePropertyGetterDelegateByTypedRef<float>(propertyTypeInfo.propertyInfo);
                            break;
                        case SerializationType.Double:
                            propertyTypeInfo.getter = EmitUtil.GeneratePropertyGetterDelegateByTypedRef<double>(propertyTypeInfo.propertyInfo);
                            break;
                        case SerializationType.Char:
                            propertyTypeInfo.getter = EmitUtil.GeneratePropertyGetterDelegateByTypedRef<char>(propertyTypeInfo.propertyInfo);
                            break;
                        case SerializationType.Decimal:
                            propertyTypeInfo.getter = EmitUtil.GeneratePropertyGetterDelegateByTypedRef<decimal>(propertyTypeInfo.propertyInfo);
                            break;
                        case SerializationType.DateTime:
                            propertyTypeInfo.getter = EmitUtil.GeneratePropertyGetterDelegateByTypedRef<DateTime>(propertyTypeInfo.propertyInfo);
                            break;
                        case SerializationType.DateTimeOffset:
                            propertyTypeInfo.getter = EmitUtil.GeneratePropertyGetterDelegateByTypedRef<DateTimeOffset>(propertyTypeInfo.propertyInfo);
                            break;
                        case SerializationType.TimeSpan:
                            propertyTypeInfo.getter = EmitUtil.GeneratePropertyGetterDelegateByTypedRef<TimeSpan>(propertyTypeInfo.propertyInfo);
                            break;
                        case SerializationType.Vector2:
                            propertyTypeInfo.getter = EmitUtil.GeneratePropertyGetterDelegateByTypedRef<Vector2>(propertyTypeInfo.propertyInfo);
                            break;
                        case SerializationType.Vector3:
                            propertyTypeInfo.getter = EmitUtil.GeneratePropertyGetterDelegateByTypedRef<Vector3>(propertyTypeInfo.propertyInfo);
                            break;
                        case SerializationType.Vector4:
                            propertyTypeInfo.getter = EmitUtil.GeneratePropertyGetterDelegateByTypedRef<Vector4>(propertyTypeInfo.propertyInfo);
                            break;
                        case SerializationType.Quaternion:
                            propertyTypeInfo.getter = EmitUtil.GeneratePropertyGetterDelegateByTypedRef<Quaternion>(propertyTypeInfo.propertyInfo);
                            break;
                        case SerializationType.Rect:
                            propertyTypeInfo.getter = EmitUtil.GeneratePropertyGetterDelegateByTypedRef<Rect>(propertyTypeInfo.propertyInfo);
                            break;
                        case SerializationType.Bounds:
                            propertyTypeInfo.getter = EmitUtil.GeneratePropertyGetterDelegateByTypedRef<Bounds>(propertyTypeInfo.propertyInfo);
                            break;
                        case SerializationType.IntVector2:
                            propertyTypeInfo.getter = EmitUtil.GeneratePropertyGetterDelegateByTypedRef<IntVector2>(propertyTypeInfo.propertyInfo);
                            break;
                        case SerializationType.IntVector3:
                            propertyTypeInfo.getter = EmitUtil.GeneratePropertyGetterDelegateByTypedRef<IntVector3>(propertyTypeInfo.propertyInfo);
                            break;
                        case SerializationType.IntVector4:
                            propertyTypeInfo.getter = EmitUtil.GeneratePropertyGetterDelegateByTypedRef<IntVector4>(propertyTypeInfo.propertyInfo);
                            break;
                        case SerializationType.PrimitiveArray:
                        case SerializationType.PrimitiveList:
                        case SerializationType.ObjectArray:
