...
#pragma warning restore 168
        ...
        /// </summary>
        public static float Normalize(this float source, float curMin, float curMax)
        {
            return source.Normalize(curMin, curMax, 0, 1);
        }

        /// <summary>
        /// Normalizes a float between 0 and 1. Assuming current min is 0.
        /// </summary>
        public static float Normalize(this float source, float curMax)
        {
            return source.Normalize(0, curMax, 0, 1);
        }
