...
namespace Expanse.Misc
{
    ...
    public struct Half : IComparable, IFormattable, IConvertible, IComparable<Half>, IEquatable<Half>
    {
        ...
        public Half(float value) { this = HalfUtil.SingleToHalf(value); }
        /// <summary>
        ...
        public static Half operator -(Half half) { return HalfUtil.Negate(half); }
        /// <summary>
        ...
        public static implicit operator float(Half value) { return (float)HalfUtil.HalfToSingle(value); }
        /// <summary>
        ...
        {
            return HalfUtil.IsInfinity(half);
        }
        /// <summary>
        ...
        {
            return HalfUtil.IsNegativeInfinity(half);
        }
        /// <summary>
        ...
        {
            return HalfUtil.IsPositiveInfinity(half);
        }
