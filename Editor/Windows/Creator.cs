    ...
    public class Creator : ExpanseWindow
    {
        ...
        protected override void OnDrawContent()
        {
            ...
            if (selectedType != null)
            {
                ...
                if (!constructors.IndexExists(ScriptObjData.selectedConstructorIndex))
                    ScriptObjData.selectedConstructorIndex = 0;

                selectedConstructor = IListExt.SafeGet(constructors, ScriptObjData.selectedConstructorIndex);
